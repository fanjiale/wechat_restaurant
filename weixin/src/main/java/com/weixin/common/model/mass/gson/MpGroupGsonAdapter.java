...
public class MpGroupGsonAdapter implements JsonSerializer<MpGroup>, JsonDeserializer<MpGroup> {

  public JsonElement serialize(MpGroup group, Type typeOfSrc, JsonSerializationContext context) {
  ...
  public MpGroup deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    MpGroup group = new MpGroup();
