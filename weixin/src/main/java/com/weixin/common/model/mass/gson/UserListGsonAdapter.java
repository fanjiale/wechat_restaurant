...
public class UserListGsonAdapter implements JsonDeserializer<MpUserList> {

  public MpUserList deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
    JsonObject o = json.getAsJsonObject();
    MpUserList wxMpUserList = new MpUserList();
