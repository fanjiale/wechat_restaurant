...
public class UserBoundSMOImpl implements UserBoundSMO{
	...
	public String queryBoundAccNbr(String openId){
		return userBoundBMO.queryBoundAccNbr(openId);
	}
	...
	public Map<String,Object> insertBoundAccNbr(UserBound userBound){
		...
		try{
			String productNo = userBound.getAccNbr(); //用户号码
			String verCode = userBound.getVerCode();  //验证码
	...
	public Map<String,Object> saveWechatUser(WechatUser wechatUser){
		Map<String,Object> retMap = new HashMap<String,Object>();
		String resultCode = CommonConstants.EXTRACT_SUCESS;
		String resultDesc = "保存成功";
		try{
			String openId = userBoundBMO.queryWechatUserByOpenId(wechatUser.getOpenId());
